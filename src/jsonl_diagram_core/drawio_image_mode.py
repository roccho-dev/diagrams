...
def wrap_svg_as_drawio_image(svg: str, *, diagram_id: str = "diagram", width: int = 1200, height: int = 800) -> str:
    ...
    return f'<mxfile host="app.diagrams.net"><diagram id="{escape(diagram_id)}" name="Page-1"><mxGraphModel><root><mxCell id="0"/><mxCell id="1" parent="0"/><mxCell id="svg-image" jsonlType="imageExact" value="" style="{escape(style)}" vertex="1" parent="1"><mxGeometry x="0" y="0" width="{width}" height="{height}" as="geometry"/></mxCell></root></mxGraphModel></diagram></mxfile>'
